...
class CCTableVM<T> extends BaseViewModel {
  ...
  CCTableVM(this.pageSize, this.apiController, this.refreshKey) {
    currentPage = 0;
    loadMore = true;
    searchString = "";
    debugPrint('IN CCC TableViewModel +++++++++++++++');
    getController();
    notificationReceive();
    // onRefresh();
  }
  ...
  getController() {
    subscription = apiController.stream.listen((String data) {
      debugPrint(
          'IN GenericDataTableViewModel2 +++++++++++++++________${data}__________+++++++++++++++++');
      try {
